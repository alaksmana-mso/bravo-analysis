...
3. **Check whether failed geolocation attempts are billed (S — up to Rp64.0M/month).** Rp64M of Maps APIs on a console with 20,690 geolocation failures a week. Establish whether the two are related before deciding anything.
...
| **Audit Maps spend against failed geolocation** — Rp64.0M/month against ~20,700 browser geolocation failures a week on the same console | 3 | FinOps + S&U | 2 d | Either a defect is fixed and money returns, or the spend is justified and stops being an open question |
