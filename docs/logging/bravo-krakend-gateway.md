...
**Production volume:** 943,080 warn, 242,434 error, no info at all
...
`prod-ms-krakend-gateway` writes 943,080 warn, 242,434 error, no info at all over the 7 days to 13 September 2026.
...
**Pull request: [bravo-krakend-gateway#387](https://github.com/bfi-finance/bravo-krakend-gateway/pull/387)** — closed 14 September 2026 (see above).  
...
[Files changed](https://github.com/bfi-finance/bravo-krakend-gateway/pull/387/files) · [Commits](https://github.com/bfi-finance/bravo-krakend-gateway/pull/387/commits) · [Compare against master](https://github.com/bfi-finance/bravo-krakend-gateway/compare/master...fix/logging)
