...
**Pull request: [bravo-agreement-service#2604](https://github.com/bfi-finance/bravo-agreement-service/pull/2604)** — open, not merged.
Branch: [`fix/logging`](https://github.com/bfi-finance/bravo-agreement-service/tree/fix/logging), head `a37b040a9`, branched from `master`.

[Files changed](https://github.com/bfi-finance/bravo-agreement-service/pull/2604/files) · [Commits](https://github.com/bfi-finance/bravo-agreement-service/pull/2604/commits) · [Compare against master](https://github.com/bfi-finance/bravo-agreement-service/compare/master...fix/logging)
...
**Codacy review, answered 18 September 2026.** 2 Codacy thread(s); 2 fixed in `bb119f5ff` (fix(logging): remove the level pin that never reached the anonymous filter; fix the comment). Every thread is replied to and resolved on the pull request.
...
- fix(logging): stop the request-logging filter capturing payloads
