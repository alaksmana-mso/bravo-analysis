...
**Proposed change to this file:** sections §1, §3 of [deployment-proposal.md](deployment-proposal.md) — a ready-to-apply diff, not applied. SRE and the owning squad decide.
...
**Pull request: [portfolio-management-service#122](https://github.com/bfi-finance/portfolio-management-service/pull/122)** — open.  
