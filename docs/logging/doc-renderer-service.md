...
**Proposed change to this file:** sections §1, §2, §3 of [deployment-proposal.md](deployment-proposal.md) — a ready-to-apply diff, not applied. SRE and the owning squad decide.
